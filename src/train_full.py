"""Full fine-tuning of SmolVLM on the configured domain captioning dataset.
...
from src.model_utils import enable_gradient_checkpointing, load_base_model_and_processor
...
def main(config_path: str) -> None:
    ...
    stats = print_trainable_params(model, label="full-finetune")
    ...
    out_dir = cfg["training"]["output_dir_full"]
    ...
    args = TrainingArguments(
        ...
        learning_rate=cfg["training"]["learning_rate_full"],
        ...
        run_name=cfg["logging"].get("run_name_full", "smolvlm-full-finetune"),
        remove_unused_columns=False,
        label_names=["labels"],
    )

    wandb_run = init_wandb(cfg, args.run_name, job_type="train_full")
